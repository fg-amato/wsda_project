...
<main class="flex-shrink-0">
    ...
    <div class="container">
        ...
        <div
                class="alert alert-info alert-dismissible ${(transactionCreatedNumber!=null && transactionCreatedNumber!=0)?'':'d-none' }"
                role="alert" id="info">
            <strong>Hai delle transazioni in attesa</strong>
            ...
            <div class='card-body'>
                ...
                <form method="get" action="${pageContext.request.contextPath }/shared/ExecuteReportServlet"
                    ...
                    <div class="col-md-6 mt-4">
                        ...
                        <input type="hidden" name="userTypeParam" value="MERCHANT">
                    </div>
        ...
        <div align="center" class="mt-5"><h3>Vuoi effettuare un'operazione? Clicca <a href="${pageContext.request.contextPath}/merchant/PrepareInsertTransactionServlet">qui</a></h3></div>
    </div>
